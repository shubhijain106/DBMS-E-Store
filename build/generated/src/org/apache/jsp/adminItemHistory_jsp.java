...
public final class adminItemHistory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                            ");
                                ...
                                String query = "Select item.ITEM_NAME,category.CNAME, item.PRICE,item.ITEM_MANUFACTURER,counter "
                                        + "from item,category, (SELECT ITEMHT_ID, count(*) as counter FROM history GROUP BY history.ITEMHT_ID) "
                                        + "where ITEM_ID = ITEMHT_ID and C_ID = Cat_ID "
