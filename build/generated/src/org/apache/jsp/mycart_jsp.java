...
public final class mycart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    .buttons{margin-left: 700px; margin-top: -50px;margin-bottom: 30px;}\n");
      out.write("    .total{margin-left: 550px;}\n");
      out.write("    .buttons2{margin-left: 600px; margin-bottom: 80px;}\n");
      out.write("    \n");
      out.write("</style>\n");
      out.write("</head>\n");
      out.write("<body>\n");
      ...
      out.write("    <div class=\"serv\">\n");
			...
			ResultSet rs = st.executeQuery("select user_id from customer where uname='Benjamin Stephens'");
				...
				while(rs.next()){
                        ...
                        ResultSet rs1 = st.executeQuery("select * from cart where userct_id='"+ id1 + "'");
      ...
      out.write("                    \n");
      out.write("                    <tr><td><h2>Product Name</h2></td><td colspan=\"7\"><h2>Price</h2></td><td colspan=\"7\"><h2>Quantity</h2></td><td colspan=\"7\"><h2>Delete</h2></td></tr>\n");
      out.write("                      \n");
      out.write("                </table>\n");
      out.write("    </div>\n");
      out.write("                    <div class=\"buttons\">\n");
      out.write("                        <form action=\"myprofile.jsp\">    \n");
      ...
      out.write("                        <tr><td colspan=\"7\"><h3>Total:</h3></td><td colspan=\"7\"><h3>$</h3></td></tr>\n");
      out.write("                        <tr><td colspan=\"7\"><h3>Taxes(Applicable):</h3></td ><td colspan=\"7\"><h3>$</h3></td></tr>\n");
      out.write("                        <tr><td colspan=\"7\"><h3>Shipping & Handling:</h3></td><td colspan=\"7\"><h3>$</h3></td></tr>\n");
      out.write("                        <tr><td colspan=\"7\"><h3>Amount to be Paid:</h3></td><td colspan=\"7\"><h3>$</h3></td></tr>\n");
      out.write("                    </table>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"buttons2\">\n");
