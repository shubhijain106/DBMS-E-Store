  ...
  <div id="main_content">
    ...
    <div class="serv">
			...
			ResultSet rs2 = st.executeQuery("select * from item where item_name='"+ parts[0]+ "'");
                        ...
                        ResultSet rs5 = st.executeQuery("select * from wishlist where itemwl_id='"+ iname+ "' and userwl_id='"+id1+"'");
                        if(!(rs5.next())){
                        int r1=st.executeUpdate("insert into wishlist values('"+id1+"','"+iname+"',(to_date(sysdate, 'dd/mm/yyyy')),'"+price1+"')");
                       
                        
			
                                
                        ResultSet rs1 = st.executeQuery("select * from wishlist where userwl_id='"+ id1 + "'");
         ...
         {  %>
         <tr><td><h2><%=itemnames.get(i)%></h2></td><td colspan="7"><h2><%=price.get(i)%></h2></td><td colspan="7"><h2><a href=<%="\"random1.jsp?Id="+itemid.get(i)+"/"+id1+"\""%>>Delete</a></h2></td><td colspan="7"><h2><a href=<%="\"random3.jsp?Id="+itemid.get(i)+"/"+id1+"/"+itemnames.get(i)+"/"+price.get(i)+"\""%>>ADD</a></h2></td></tr>  
