  ...
  <div id="main_content">
    ...
    <div class="serv">
			...
			Statement st=c.createStatement();
                        int r = st.executeUpdate("Delete from wishlist where itemwl_id='"+parts[0]+"'");
                        if (r>0)
                        {
                          
                          
                          request.getRequestDispatcher("viewmywishlist.jsp?Id="+parts[1]).forward(request, response);
                        }
			else
                        {
                            response.sendRedirect("viewmywishlist.jsp");
                        }
                }
