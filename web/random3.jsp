  ...
  <div id="main_content">
    ...
    <div class="serv">
			...
			Statement st=c.createStatement();
                        int r = st.executeUpdate("Delete from wishlist where itemwl_id='"+parts[0]+"' and userwl_id='"+parts[1]+"'");
                        if (r>0)
                        {
                          int r1=st.executeUpdate("insert into cart values('"+parts[1]+"','"+parts[0]+"','1','"+parts[3]+"')");
                          if(r1>0){
